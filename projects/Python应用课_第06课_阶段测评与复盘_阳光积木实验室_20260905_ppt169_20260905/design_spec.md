...
| mascot_turtle_new_commands_v2.png | 1122 × 1402 | 0.80 | P13 新命令实验主题角色 | transparent character illustration | 右侧完整显示，放大镜与无字命令牌保持可见 | no-crop | ai | Generated | 项目既有 AI 生成透明角色图，无文字与水印 | none | content_page |
| mascot_turtle_flower_workshop_v2.png | 1122 × 1402 | 0.80 | P30 微项目装配主题角色 | transparent character illustration | 右侧完整显示海龟、工作台和积木花 | no-crop | ai | Generated | 项目既有 AI 生成透明角色图，无文字与水印 | none | content_page |
